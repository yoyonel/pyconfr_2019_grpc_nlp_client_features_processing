...
setup(
    name="pyconfr_2019_grpc_nlp_client_features_processing",
    author="Lionel ATTY",
    author_email="yoyonel@hotmail.com",
    url="https://github.com/yoyonel/pyconfr_2019_grpc_nlp_client_features_processing.git",
    ...
    entry_points={
        "console_scripts": [
            # RPC Client Storage
            "pyconfr_2019_grpc_nlp_client_features_processing = features_processing.client_rpc:main"
        ]
    },
